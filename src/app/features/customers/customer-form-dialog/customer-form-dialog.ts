...
import { Customer as CustomerService, CustomerPayload } from '../../../shared/services/customer/customer';
...
function toCustomerPayload(value: CustomerFormModel): CustomerPayload {
  return {
...
export class CustomerFormDialog {
  ...
  protected onSportIdsChange(sportIds: number[]): void {
    this.model.update((m) => ({ ...m, sportIds }));
  }
}
